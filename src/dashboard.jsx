...
function Sidebar({ activePage, setActivePage, onLogout }) {
    const navSections = [
        ...
        },
        {
            ...
            items: [
                { id: 'txn_specialist', label: 'Transaction Specialist', icon: <IconSpecialist /> },
                { id: 'reviewer', label: 'Reviewer Dashboard', icon: <IconReviewer /> },
            ],
        },
    ];
    ...
    return (
        <aside className="sidebar">
            ...
            <div className="sidebar-logo">
                ...
                <span className="sidebar-logo-text">Data Hub</span>
            </div>
